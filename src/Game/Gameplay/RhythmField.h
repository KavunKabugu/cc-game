...
public:
    RhythmField(UnitBounds bounds, std::shared_ptr<SDL_Texture> arcTexture, std::shared_ptr<SDL_Texture> crosshairTexture, std::shared_ptr<SDL_Texture> crosshairInnerTexture, const NoteSimulation* sim);
