...
void TestConcurrentOnlyChord() {
    ...
    [[maybe_unused]] const float w = ResultsGraphDeltaBarWidthPx(
...
void TestEpsilonNxFromDomain() {
    [[maybe_unused]] const float e = ConcurrentSlotEpsilonNx(0.0, 10.0);
    [[maybe_unused]] constexpr float expected = 0.5e-3 / 10.0;
